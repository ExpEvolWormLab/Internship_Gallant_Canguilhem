...
sum(is.na(raw_fec_data)) #lots of NAs because no data for block 1, 5th day and 10 plates on 2nd block == only 5 missing values due to survey error
...
#we create a column that contains the number of worms the day before (theorically 5/5 and correct those who must be)
...
```{r}
#do we check that the number of males is enough regarding of fem/herm ? how do we define it ?
...
#long format for François who likes it
